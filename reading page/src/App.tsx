...
import { Search, Menu, BookOpen, Bookmark, Headphones, ArrowUpLeft, ArrowLeft, Maximize, Minimize, Type, Plus, Minus, Share2, List, X, Clock } from 'lucide-react';
          ...
          >
            <div className="flex justify-between items-center px-6 md:px-12 max-w-7xl mx-auto">
              ...
              <div className="flex gap-4 items-center">
                <button className="p-2.5 hover:bg-accent/5 rounded-full transition-all duration-300 text-accent">
