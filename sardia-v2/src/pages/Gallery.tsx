...
export default function Gallery() {
  ...
  return (
    <div className="px-5 md:px-12 max-w-7xl mx-auto pt-24 md:pt-28">
      ...
      />
      {/* Hero Section */}
      <header ref={heroRef} className="mb-16 md:mb-24 max-w-4xl relative z-10">
        <RevealText
      ...
      {/* Bento Gallery Grid */}
      {!loading && !error && works.length > 0 && (
        <section className="grid grid-cols-1 md:grid-cols-4 gap-5 md:gap-6 md:grid-rows-2 mb-24 md:mb-40">
