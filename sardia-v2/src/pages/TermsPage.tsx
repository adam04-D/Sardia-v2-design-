  ...
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-5 md:px-12 pt-24 pb-16 md:py-24 font-serif text-base md:text-lg text-text-main leading-[1.9] md:leading-[2] text-right" dir="rtl">
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl text-primary font-bold mb-8 md:mb-10">شروط الاستخدام</h1>
        <p className="font-sans text-sm text-text-muted mb-10">آخر تحديث: أبريل 2026</p>

        <section className="space-y-6">
          <h2 className="text-xl sm:text-2xl font-bold text-primary mt-8">المحتوى الأدبي</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-primary mt-8">تعقيبات القراء</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-primary mt-8">حدود المسؤولية</h2>
          <p>
            يُقدَّم الموقع "كما هو". نبذل جهداً معقولاً لضمان استمرار الخدمة، لكن لا نضمن خلوها من الأعطال أو الانقطاعات.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold text-primary mt-8">القانون المعمول به</h2>
