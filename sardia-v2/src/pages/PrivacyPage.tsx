...
export default function PrivacyPage() {
  return (
    <>
      ...
      <article className="max-w-3xl mx-auto px-5 md:px-12 pt-24 pb-16 md:py-24 font-serif text-base md:text-lg text-text-main leading-[1.9] md:leading-[2] text-right" dir="rtl">
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl text-primary font-bold mb-8 md:mb-10">سياسة الخصوصية</h1>
        <p className="font-sans text-sm text-text-muted mb-10">آخر تحديث: أبريل 2026</p>

        <section className="space-y-6">
          <h2 className="text-xl sm:text-2xl font-bold text-primary mt-8">البيانات التي نجمعها</h2>
          <p>
            عند ترك تعقيب أو الاشتراك في تجربة القراءة، نخزن اسمك ومحتوى التعقيب فقط. لا نطلب بريدك الإلكتروني أو أي بيانات شخصية أخرى.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold text-primary mt-8">ملفات تعريف الارتباط (Cookies)</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-primary mt-8">حقوقك</h2>
          <p>
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-primary mt-8">التحديثات</h2>
