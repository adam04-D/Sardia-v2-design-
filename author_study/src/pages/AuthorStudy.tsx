...
import { Mail, FileText, Eye, Heart, ArrowUpLeft } from 'lucide-react';
    ...
    <>
      ...
      <section className="space-y-16 mb-40">
        <div className="flex justify-between items-end border-b border-accent/10 pb-6">
          ...
          <Link to="/" className="font-sans text-sm font-bold text-accent hover:text-primary transition-colors flex items-center gap-2 group">
            مشاهدة الكل
